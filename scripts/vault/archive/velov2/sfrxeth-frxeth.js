...
const want = web3.utils.toChecksumAddress("0xFF5318f81Dd791e92d51b8A54fA3538832D2890D");
const gauge = web3.utils.toChecksumAddress("0x325c9CbbF46aaeCD4354b9Ee793197AA78ebf682");

const vaultParams = {
  mooName: "Moo VeloV2 sfrxETH-frxETH",
  mooSymbol: "mooVeloV2sfrxETH-frxETH",
  delay: 21600,
};
...
const strategyParams = {
  ...
  outputToLp0Route: [
    [VELOV2, USDC, false, zero],
    [USDC, ETH, false, zero],
    [ETH, frxETH, true, zero],
    [frxETH, sfrxETH, true, zero],
  ],
  outputToLp1Route: [
    [VELOV2, USDC, false, zero],
    [USDC, ETH, false, zero],
