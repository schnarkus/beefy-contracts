...
const want = web3.utils.toChecksumAddress("0x2B47C794c3789f499D8A54Ec12f949EeCCE8bA16");
const gauge = web3.utils.toChecksumAddress("0xa2f27d183A4E409c734367712f9344328f8EC98D");

const vaultParams = {
  mooName: "Moo VeloV2 USDC-USDT",
  mooSymbol: "mooVeloV2USDC-USDT",
  delay: 21600,
};
...
const strategyParams = {
  ...
  outputToLp0Route: [[VELOV2, USDC, false, zero]],
  outputToLp1Route: [
    [VELOV2, USDC, false, zero],
    [USDC, USDT, true, zero],
  ],
