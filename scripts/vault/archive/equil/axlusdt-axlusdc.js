...
const {
  platforms: { equilibre, beefyfinance },
  tokens: {
    VARA: { address: VARA },
    KAVA: { address: KAVA },
    USDC: { address: USDC },
...
const axlUSDT = web3.utils.toChecksumAddress("0x7f5373AE26c3E8FfC4c77b7255DF7eC1A9aF52a6");

const want = web3.utils.toChecksumAddress("0xFc8A7260945a3A07433d2C4EfacfcAD54BA35F36");
const gauge = web3.utils.toChecksumAddress("0xf6622d4d4F6aAe6F516f2fB00bA421734a48A5f9");

const vaultParams = {
  mooName: "Moo Equilibre axlUSDT-axlUSDC",
  mooSymbol: "mooEquilibreaxlUSDT-axlUSDC",
  delay: 21600,
};
