...
const {
  ...
  tokens: {
    ...
    KAVA: { address: KAVA },
    USDT: { address: USDT },
    axlUSDT: { address: axlUSDT },
  },
} = addressBook.kava;

const want = web3.utils.toChecksumAddress("0x6337e3a13CB76d93856E7403B7f98A37CB2bc7dF");
const gauge = web3.utils.toChecksumAddress("0x1f343A11b317EB54F08D80FD3cF9d706eDA5982c");

const vaultParams = {
  mooName: "Moo Equilibre axlUSDT-USDT",
  mooSymbol: "mooEquilibreaxlUSDT-USDT",
  delay: 21600,
};
