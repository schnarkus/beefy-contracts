...
import stratAbi from "../../artifacts/contracts/BIFI/strategies/Beethovenx/StrategyBalancerMultiRewardChefUniV2.sol/StrategyBalancerMultiRewardChefUniV2.json";
...
const want = web3.utils.toChecksumAddress("0xCE752063c544F604Ddb99a4335EB79B38c439D72");

const vaultParams = {
  mooName: "Moo Beets A Layered Quartet",
  mooSymbol: "mooBeetsALayeredQuartet",
  delay: 21600,
};
...
const strategyParams = {
  want: want,
  switches: [0, 0], //isComposable, isBeets
  nativeToInputRoute: [["0xce752063c544f604ddb99a4335eb79b38c439d7200010000000000000000075c", 0, 1]],
  outputToNativeRoute: [["0x9e4341acef4147196e99d648c5e43b3fc9d026780002000000000000000005ec", 0, 1]],
  assets: [
    [BEETS, FTM], //outputToNativeAssets
    [FTM, FTM], //nativeToInputAssets
  ],
  chef: beethovenx.masterchef,
  poolId: 126,
  rewardAssets: [lzUSDC, FTM],
  rewardRoute: [["0x838229095fa83bcd993ef225d01a990e3bc197a800020000000000000000075b", 0, 1]],
  ...
  strategyImplementation: "0x9667C9Da1125ADBd397d3b375b74E59F863Cb525",
};
