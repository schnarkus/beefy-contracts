...
const USDP = web3.utils.toChecksumAddress("0xB79DD08EA68A908A97220C76d19A6aA9cBDE4376");

const want = web3.utils.toChecksumAddress("0x8E9154AC849e839d60299E85156bcb589De2693A");
const gauge = web3.utils.toChecksumAddress("0x969c70383A95704C6a35497d8C77BF38dc152e63");

const vaultParams = {
  mooName: "Moo Aero DOLA-USD+",
  mooSymbol: "mooAeroDOLA-USD+",
  delay: 21600,
};
...
const strategyParams = {
  ...
  outputToLp0Route: [
    [AERO, USDbC, false, zero],
    [USDbC, DOLA, true, zero],
  ],
  outputToLp1Route: [
    [AERO, USDbC, false, zero],
    [USDbC, USDP, true, zero],
  ],
