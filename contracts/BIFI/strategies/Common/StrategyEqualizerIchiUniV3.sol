...
contract StrategyEqualizerIchiUniV3 is StratFeeManagerInitializable, GasFeeThrottler {
    ...
    function initialize(
        ...
        uniV3Router = 0x1F7A12B40bFc8e8561008Bc2ca1FBdc71A36d0e8;
    ...
    function addLiquidity() internal {
        ...
        if (native != depositToken) {
            UniV3Actions.swapV3(uniV3Router, nativeToDepositPath, nativeBal);
        }
